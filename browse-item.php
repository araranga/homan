...
<html class=" js cssanimations csstransitions" hola_ext_inject="disabled">
   <head>
      ...
      <meta charset="utf-8">
<meta property="og:title" content="<?php echo $_GET['itemdata']['title'];?>" />
<meta property="og:description" content="<?php echo $_GET['itemdata']['title'];?> by <?php echo $_GET['itemdata']['firstName'];?> <?php echo $_GET['itemdata']['lastName'];?>" />
<meta property="og:image" content="<?php echo $_GET['itemdata']['pictures'][0];?>" />
<meta property="og:site_name" content="Chelra"/>

      <title><?php echo $_GET['itemdata']['title'];?> by <?php echo $_GET['itemdata']['firstName'];?> <?php echo $_GET['itemdata']['lastName'];?> </title>
      <meta name="description" content="<?php echo $_GET['itemdata']['title'];?> by <?php echo $_GET['itemdata']['firstName'];?> <?php echo $_GET['itemdata']['lastName'];?>">
